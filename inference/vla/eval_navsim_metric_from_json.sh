...
# 实验路径和名称（可通过环境变量覆盖）
export EXPERIMENT_PATH="${EXPERIMENT_PATH:-/mnt/vdb1/shuyao.shang/VLA_Emu_Huawei/logs/new_train_navsim_pi0_vava_from_nuplan_ft/json_output_cursor_clean}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-train_navsim_pi0_vava_from_nuplan_ft/json_output_cursor_clean}"
